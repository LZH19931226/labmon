...
public class cmdidParseUtils {
    ...
    public static ParamaterModel pase90(String data) {
        ...
        String temp1 = CustomUtils.agreementAll(s, "-200", "40");
    ...
    public static ParamaterModel pase93(String cmd) {
        ...
        String substring1 = cmd.substring(28, 32);//温度
        String substring2 = cmd.substring(32, 36);//co2
        String substring3 = cmd.substring(36, 40);//RH
        String substring4 = cmd.substring(40, 44);//O2
