//package com.hc.my.common.core.http;
//
...
//	}
//
//	public static String postJson(String postUrl,Map<String, String> postHeaders, String postEntity) {
...
//	}
//
//	public static String getHeader(String url,Map<String, String> Header, Map<String, String> params) {
//		CloseableHttpClient client = HttpClients.createDefault();
//		HttpGet get =    new HttpGet(url);
//		get.setConfig(getRequsetConfig());
...
//					nameValuePairs.add(new BasicNameValuePair(param.getKey(), param.getValue()));
//				}
//				String str = EntityUtils.toString(new UrlEncodedFormEntity(nameValuePairs,Charset.defaultCharset()));
//				if(url.contains("?")){
//					url = url + "&"+str;
//				}else{
//					url = url + "?"+str;
...
//			}
//			HttpResponse response = client.execute(get);
//			return handleResponse(url,response, DEFAULT_CHARSET);
//		} catch (IOException e) {
//			throw new RuntimeException(e);
//		} catch (URISyntaxException e) {
//			throw new RuntimeException(e);
...
//		String url ="http://localhost:8092/getUser";
//		Map<String,String> map = new HashMap<>(1);
//		map.put("token","hc83754648");
