...
public class DateUtil {
     ...
     * 获取某天加上几天后的一天
     * @param date 某一天
     * @param latersNum 几天以后
     * @return
     * @throws Exception
     */
    public static String getDateStrAfterSomeDays(Object date, int latersNum) throws Exception {
        String latersDate = null;
        Calendar calendar = Calendar.getInstance();
        if(date instanceof String){
            System.out.println("date = " + date);
            Date oldDate = convertStringToDate(DATE_FORMAT, (String)date);
            calendar.setTime(oldDate);

            calendar.add(Calendar.DATE, latersNum);
        ...
        return getDateTime(DATE_FORMAT, calendar.getTime());
    }
     ...
     * @throws Exception
     */
    public static Date getDateAfterSomeDays(Object date, int latersNum) throws Exception {
        String latersDate = null;
        Calendar calendar = Calendar.getInstance();
        if(date instanceof String){
            System.out.println("date = " + date);
    ...
    public static Date convertStringToDate(String strDate)
        ...
        try {
            ...
            logger.debug("Could not convert '" + strDate + "' to a date, throwing exception");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String beginDate = DateUtil.getDateStrAfterSomeDays(new Date(), -7);
        String endDate = DateUtil.getDateStrAfterSomeDays(new Date(), -1);
