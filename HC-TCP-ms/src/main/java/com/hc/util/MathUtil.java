...
//4843 71 0C 31 38 30 36 39 39 30 32 30 30 01EF 95 23
		...
		String   ruleone = "4843a11a313838383135303030310e740e730e720e710e700e6f0e6e0e6da423 ";
	...
	public static List<String> ruleone(String data) {
		...
		for (int i = 0; i < i1-3; i++) {
			...
			if (StringUtils.equals(String.valueOf(a) + String.valueOf(b) + String.valueOf(c) + String.valueOf(d),
				...
				if (!String.valueOf(l).equals("7")&&!String.valueOf(l).equals("8")&&!String.valueOf(l).equals("9") &&l!='a' &&l!='b' &&l!='c' &&l!='d' &&l!='e' &&l!='f') {
					continue;
				}
				int ta=i + 7;
				if (ta<data.length()) {
					...
					int g = Integer.valueOf(parseInt) * Integer.valueOf(2);
					int t = i + 7 + g + 4;
					if (t < data.length()) {
